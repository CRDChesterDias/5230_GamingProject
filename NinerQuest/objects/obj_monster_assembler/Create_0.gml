...
part_emitter_region(part_system,part_emitter,obj_monster_full.x+40,obj_monster_full.x+200,obj_monster_full.y+50,obj_monster_full.y+250,ps_shape_ellipse,ps_distr_gaussian)
